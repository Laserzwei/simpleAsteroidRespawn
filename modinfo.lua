...
meta =
{
    ...
    name = "simpleAsteroidRespawn",

    -- Title of your mod that will be displayed to players
    title = "Laserzwei's simple asteroid respawn mod",

    -- Description of your mod that will be displayed to players
    description = "This mod simplyfies the vanilla asteroid respawing mechanic and extends it for live updates.",
